...
def intersection(lst1, lst2): 
    lst3 = []
    for pos, steps in lst1.items():
        if pos in lst2.keys():
            lst3.append(steps + lst2[pos])
    return lst3

w1 = routeWire(wire1)
w2 = routeWire(wire2)

intersect = intersection(w1, w2)
small = min(intersect)
print(small)